...
const createAdminContact = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { data, message } = yield adminContact_service_1.AdminContactServices.createAdminContactIntoDB(req.body);
...
const getAdminContact = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield adminContact_service_1.AdminContactServices.getAdminContactFromDB();
    (0, sendResponse_1.default)(res, {
        statusCode: 200,
